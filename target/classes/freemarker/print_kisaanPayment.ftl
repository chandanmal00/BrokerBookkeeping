...
<body>
    <div class="container-fluid">
        ...
        <div class="hidden-print" style="text-align: right;">
            <a class="btn btn-info hidden-print" href="/invoice/kisaanPayment/${entityObject.getUniqueKey()}/kisaan">See Invoice <i class="fa fa-print fa-2x" aria-hidden="true"></i> </a>
        </div>
