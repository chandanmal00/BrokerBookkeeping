...
public class ItemTransactionDAOImpl extends MongoCollectionDAOImpl<ItemTransaction> implements ItemTransactionDAO {
    ...
    @Override
    protected Document uniqueDocument(ItemTransaction itemTransaction) {
        return new Document()
                .append(Constants.UNIQUE_KEY,
                        itemTransaction.getUniqueKey());
    }

    @Override
    protected Document getDocument(ItemTransaction itemTransaction) {
        return Document.parse(gson.toJson(itemTransaction));
    }

    @Override
    protected String getJsonString(ItemTransaction itemTransaction) {
        return gson.toJson(itemTransaction);
    }
    ...
    public List<String> listKeys() {
        ...
        List<ItemTransaction> list = super.list();
        for(ItemTransaction k : list) {
