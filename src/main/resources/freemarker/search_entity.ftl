...
<html lang="en">
  <head>
    ...
    <title>Search within ${ENTITY_NAME} for ${APP_TITLE}</title>
    <style>
        #state {
        display: block;
        font-weight: bold;
        ...
        <#include "/common/header.ftl">
            <div class="new_post_form">
                <form action="/searchEntity" method="POST">
                    ...
                    <h2>Search ${ENTITY_NAME} to the system</h2>
                    ...
                    <input type="submit" value="Search ${ENTITY_NAME!""}" class="btn btn-info btn-block">
                </form>
            </div>
