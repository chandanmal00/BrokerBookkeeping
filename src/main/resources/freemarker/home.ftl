...
<html lang="en">
  <head>
    ...
    <title>Book Keeping for Brokers</title>
...
<div class="carousel fade-carousel slide" data-ride="carousel" data-interval="3200" id="bs-carousel">
    <!-- Overlay -->
    <div class="overlay">
    <a href="/login" role="button" class="btn btn-hero btn-lg">Login!</a>
            <a href="/signup" role="button" class="btn btn-hero btn-lg">Signup!</a>
    </div>
    ...
    <div class="carousel-inner">
        <div class="item slides active">
            ...
            <div class="hero">
                <hgroup>
                    <h1>Broker Bookeeping</h1>
                    <h3>Get started with your records at one place</h3>
                </hgroup>
                <a href="/login" role="button" class="btn btn-hero btn-lg">Learn More</a>
            </div>
        </div>
