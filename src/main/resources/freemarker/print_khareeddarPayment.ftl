...
<body>
    <div class="container-fluid">
        ...
        <div class="hidden-print" style="text-align: right;">
               <a class="btn btn-info hidden-print" href="/invoice/khareeddarPayment/${entityObject.getUniqueKey()}/khareeddar">See Invoice <i class="fa fa-print fa-2x" aria-hidden="true"></i> </a>
        </div>
